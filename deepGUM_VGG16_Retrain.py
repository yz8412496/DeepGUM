...
class MixtureModel:
    ...
    def __init__(self):
        ...
        for layer in modelRn.layers:
            layer.trainable = False
        modelRn.layers[2].trainable = True
    ...
    def fit(self, ROOTPATH, trainT, valT, test_txt,learning_rate=0.1, itmax=2,validation=validationRatio,subsampling=1.0):
        ...
        self.fileP=ROOTPATH+"Forward_Uni_best"+PB_FLAG+"_"+"All"+"_weights.hdf5" # previous best model file
        ...
        self.network.load_weights(self.fileP)
    ...
    def M_step_network(self, ROOTPATH,trainT, valT, test_txt, learning_rate,nbEpoch=NB_EPOCH):
        ...
        (gen_training, N_train), (gen_val, N_val) = load_data_generator_Uniform_Li8„í\²F

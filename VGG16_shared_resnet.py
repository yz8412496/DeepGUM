...
from data_generator_shared_resnet import load_data_generator,load_data_generator_simple
from data_generator_shared_resnet import load_data_generator_List, load_data_generator_Uniform_List,rnEqui,rnHard,rnTra
...
class MixtureModel:
    ...
    def __init__(self):
        ...
        reg = Dense(LOW_DIM, activation='linear', name='regression')(x)
        ...
        modelRn = Model(input=[model_resnet50.input,rn], output=[cla,weightedReg])
    ...
    def fit(self, ROOTPATH, trainT, valT, test_txt,learning_rate=0.1, itmax=2,validation=validationRatio,subsampling=1.0):
        ...
        self.networkRn.compile(optimizer=sgd, loss={'classification': 'categorical_crossentropy', 'merge': 'mse'},
    ...
    def M_step_network(self, ROOTPATH, trainT, valT, test_txt, learning_rate, nbEpoch=NB_EPOCH):
        ...
        if MNdiag:
            ...
            lrcoeff=LOW_DIM*1.0/sum(self.£ú<ı.>c¯–Ñ>#¯¦Å>,ï¢3Æj-âsöZ9í<²n
...
LøÊ=hîQsƒš÷°¹KÍªy@İæ{õ¸öy:],Æb-bq[±‹¼˜[°Ä‹ì˜²JpÈÛéd±‹°˜‹ÕX ÅGìÍr*Z`Ä×ì¡rš}TŞ@§Å[ìÄ²,ŠbÖua×µaH×‰aY…1\ë†0+Ö`¡Ç±mK’H’IRII>I/‰#Ù&%%$ää´´ˆˆ™YU üÿş?ÿ¯ÿÃÿî?ó¯úüş>?¯¯ÃÃî.3£ª ı?şoÿ“ÿÒ?âoöSù=>no““Ò"rfZUÀü¯şÿ¾?Ï¯ëÃğ®;Ã¬®¾~Ÿ»×Ì¡jıSşB?oÛ“ä’4’h’QRC‚NK·ˆ‰YY<üî>3¯ªÀş/ÿ£ÿÆ?í/òcúV<Á./££Æ-="nfS•şsÿš?Ôïà³÷Ê9hírsšZÄğ¬»Â®zœş?±/Ë£è†1]+†`Öqa—´‘H“‰Ru>Xï…sÜÚ&$å$´äˆ´™H•	Pùı>>o¯“ÃÒ."c¦V<ÿ®?Ã¯îó¾:¬ûÂ<®n“¾²{Ê\¨Æm?’oÒSâB6Ni‘8“­RB~N_‹‡ØeVTÁ ¯¿ÃÏî+ó ºÌıj>PïƒóŞ:'¬åB4Îh«‘@“Òât¶X‰Y<Å.,ã¢6i=.s£šı0¾kÏ«ÓÀ¢/Æcí2q*[ Ä‡ìrZqÛ¼¤›¼”›³ÔŠ ˜çÕu`Ø×åat×˜¡UG¥zÜü¦>/¼ãÎ6+© 'ß¥gÄÕl Òâ}v^Y…=\îF3*`ô×ø¡}GMWŠAXÏ…kÜĞ¦#Å&,å"4æhµHó‰zõ68é-q"[¦D…œú<ñ.;£¬†>vo™Õ2 êgğÕ{àÜ·æ	u9í5rhÚQdÃ”®ƒ³Ş
'¸åMtÊX¨ÅAlÏ’+Ò`¢WÆAm’{Ò\¢FM=
nxÓbVq¿´È›éT± ‹¿Øå[ôÄ¸¬BNtË˜¨•APÏƒëŞ0§«Å@¬ÏÂ+î`³—Êhó‘zœò:q,Û¢$†d–p‘Ó´¢†y]v}u7˜éUq Û¿äô›ø”½PCÛ$›¤”„œ“Ö!2gªU@ÀÏïëóğº;Ììª2 êğßûçüµ~ß¹gÍjpĞÛãä¶4‰(™!U'€å_ôÇø­}B^NG‹XšETÌÀª/Àãïö3ù*= îgó•zÜóæ:5,èâ1vk™•3Ğê#ğæ;õ,¸âvzYÅ6,é"1&k¥„óÜº&å:4ìè²1JkˆĞ™cÕ ñ'û¥|„Ş§¶I<É.)#¡&¥=DîL³Š
øõ}xŞ]g†U] ÆíòwúY|Å,÷¢9Fmzr\ÚF$Í$ªd€ÔŸà—÷Ñycq1«´€ˆŸÙWåtÿ˜¿ÕOàË÷è¹qMŠt˜Ø•ePÔÃà®7Ã©n¿²Ê{èÜ±f•8íSòB:NlË’(’aRW‚A^O‡‹İX¦EEÌú*<àî7ó©zÿ¶?É/é#ñ&;¥,„â¶v	95-(âavW™U?€ïßóçú5|èŞ1g«•@ÏÓëâ0¶kÉ©3Á*/ ãÇö-y"]&Feúp¼ÛÎ$«¤€„ŸÜ—æu3˜êpğÛû
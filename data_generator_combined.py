...
def load_data_generator_List(rootpath, imIn, file_test, idx, validation=1.0,subsampling=1.0,processingTarget=None,transform=[],outSize=(224,224),batch_size=BATCH_SIZE,shuffle=False):
...
def load_data_generator(rootpath, file_train, file_test, idx, validation=1.0,subsampling=1.0,processingTarget=None,transform=[],outSize=(224,224),batch_size=BATCH_SIZE,shuffle=False):
    im = open(rootpath+file_train, 'r', encoding=encode).readlines()
    return load_data_generator_List(rootpath, im[:], file_test, idx, validation,subsampling,processingTarget=processingTarget,transform=transform,outSize=outSize,batch_size=batch_size,shuffle=shuffle)

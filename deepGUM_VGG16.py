...
class MixtureModel:
    ...
    def M_step_network(self, ROOTPATH,trainT, valT, test_txt, learning_rate,nbEpoch=NB_EPOCH):
        ...
        history=self.networkRn.fit_generator(gen_training,
                                             ...
                                             nb_≠;¬lÆRÇ~_∑á…]iQ=Æ~üæœ±kÀê®ì¡R/ÇcﬁV'Å%_§«ƒ≠lÇRBwéY[Öú¸ñ>/≥£ (˝!~güïW–¡cÔñ3—*#†Êı=xÓ]sÜZˆ|π7∫iL—
...
Y8≈-l‚R6BiQ;É¨ûæqOõã‘ò†ïG–ÕcÍV0¡+Ô†≥« -h‚QvCô;∞ÏãÚ∫uLÿ %h‰—t£òÜ]0∆kÌ≤s Z(ƒ·l∑í	Ry]>Foç⁄r$⁄d§‘Ñ†úá÷a6W©A?èØ€√‰Æ4É®ûWøÅOﬂãÁÿµeH‘…`©¡1o´ì¿í/“c‚V6A)°;«¨≠BN~KüàóŸQeî˛ø≥œ +Ë‡±wÀôhïPÛÉ˙<˜Æ9C≠{æ\èÜ›4¶hÖ\ÛÜ:,ˆb9m1k≤P